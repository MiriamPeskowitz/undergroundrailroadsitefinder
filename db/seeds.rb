...
site_4 = Site.create(name: "Johnson House Historic Site", address: "6306 Germantown Avenue", city: "Philadelphia", zipcode: "19144", description: "This circa 1768 Germantown home belonged to devout Quakers Samuel and Jennett Johnson, who, in the early 1800s, took in escaped slaves. Secret hiding spots, including a trap door in the attic, are visible today. William Still visited the house and, according to family lore, so did Harriet Tubman.", visited: "no")

site_5 = Site.create(name: "Harriet Tubman Memorial Statue", address: "150 Basin Park", city: "Bristol", zipcode: "19007", description: "A statue honoring Underground Railroad conductor Harriet Tubman sits along the Delaware River waterfront in the Bucks County town of Bristol. The statue depicts Tubman pointing in the direction of the North Star.", visited: "no")
