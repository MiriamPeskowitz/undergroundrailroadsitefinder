...
note_1 = Note.create(site.id: "1", user.id: '1', title: "", body: "magic brilliant! peachy blue down in the dumps gloomy doleful crestfallen cheerful jolly merry bold audacious confident  gutsy brash pushy bossy meek obedient  timid humble self-efffacing forceful insistent determined worried troubled distressed worked up nervous rattled tense decisive self-assured commanding in charge faint-hearted fearful bold plucky heroic normal typical ordinary expected epic monumental grand stately majestic lavish posh eminent august honored esteemed renowned")
note_2 = Note.create(site.id: "2", user.id: '1', title: "", body: "ipsum lorem change it around courageous awesome beautiful inside mellow curious intrigue interest eager inquisitive loved treasured connected kindness care energetic active spry sporty vital creative inventive resourceful inspired artistic expressive")
note_3 = Note.create(side.id: "3", user.id: '2', title: "", body: "forceful insistent determined worried troubled distressed worked up nervous rattled tense decisive self-assured commanding")
